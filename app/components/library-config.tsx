...
const LibraryConfig: React.FC<LibraryConfigProps> = ({ onSelectionChange, initialSelectedIds = [] }) => {
	...
	), [searchQuery, selectedIds.length, totalVisible, sections, selectedIdsSet, handleSearchChange, clearSearch]);
